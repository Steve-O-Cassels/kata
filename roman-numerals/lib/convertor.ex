defmodule Convertor do
  ...
  defp numeral(roman, arabic, repeat_count) when repeat_count == 4 and arabic == 1000, do: "MMMM"
  defp numeral(roman, arabic, repeat_count) when repeat_count == 4 and arabic == 100, do: "CD"
  defp numeral(roman, arabic, repeat_count) when repeat_count == 4 and arabic == 10, do: "XL"
  defp numeral(roman, arabic, repeat_count) when repeat_count == 4 and arabic == 1, do: "IV"
  defp numeral(_, _, repeat_count) when repeat_count == 0, do: ""
  defp numeral(roman, arabic, repeat_count) when repeat_count > 0 and repeat_count <= 3 do
